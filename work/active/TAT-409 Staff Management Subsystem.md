...
- [x] **TAT-421** History Form Sit-In & Final Assessment — auto-assign course instructor as Sit-In evaluator; TM final assessment → approve. *High.* **WIRED 2026-06-28 (`65d6227`).** Sit-in section: GET (404→"none yet"), evaluator submits subject+date, TM final assessment (assessed-as + signature). Empty state verified; the full create→submit→assess chain is deferred (needs the [[TAT-429 Sit-In Eligibility & Move Semantics|TAT-429]] sit-in + an evaluator). (Depends on [[TAT-429 Sit-In Eligibility & Move Semantics|TAT-429]].)
